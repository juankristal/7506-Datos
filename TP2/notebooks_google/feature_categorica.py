...
def train_agregar_feature_provincias_ciudades_ohe_reducido_df(train):
	df_feature_ciudades_provincias_ohe_reducido = pd.read_csv('/content/drive/My Drive/Colab Notebooks/data/dima_train_feature_provincias_ciudades_ohe_reducida.csv')
...
def test_agregar_feature_provincias_ciudades_ohe_reducido_df(test):
	df_feature_ciudades_provincias_ohe_reducido = pd.read_csv('/content/drive/My Drive/Colab Notebooks/data/dima_test_feature_provincias_ciudades_ohe_reducida.csv')
	nuevo_test = test.merge(df_feature_ciudades_provincias_ohe_reducido, on = 'id')
	return nuevo_test

def agregar_tipodepropiedad_precio_mean(train):
	df_precio_promedio_tipodepropiedad = pd.read_csv('/content/drive/My Drive/Colab Notebooks/data/dima_tipodepropiedad_precio_estadisticas.csv').fillna('')
