...
def train_agregar_feature_string_todos_df(train):
    df_feature_string = pd.read_csv('/content/drive/My Drive/Colab Notebooks/data/dima_train_feature_string_0.csv', )
    nuevo_train = train.merge(df_feature_string, on = 'id')
    return nuevo_train

def test_agregar_feature_string_todos_df(test):
    df_feature_string = pd.read_csv('/content/drive/My Drive/Colab Notebooks/data/dima_test_feature_string_0.csv', )
